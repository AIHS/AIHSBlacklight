...
AIHSBlacklight Solr Schema and Solrconfig File Templates



AIHS Changelog

Changed Schema.xml in Solr to follow Koha's version of MARC.
Changed Schema.rb to match Schema.xml.
Changed catalog_controler.rb to match above changes.
Changed Solr_document.rb to add call number display.
